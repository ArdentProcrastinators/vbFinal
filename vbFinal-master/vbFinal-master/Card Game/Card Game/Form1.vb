Public Class Form1
    ...
    Public Sub GenerateCreature(CreatureID As Integer, Radiant As Boolean)
        ...
        If Radiant Then
            ...
            newCreature.Top = Me.Height - newCreature.Height * 3.65
            'Bug With centering
            newCreature.Left = Me.Width / 2 + (40 * (RadiantCreatures.Count))
        Else
